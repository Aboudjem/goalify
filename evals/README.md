...
```bash
python3 evals/check_skill.py skills/goalify/SKILL.md        # GREEN: exit 0 (25/25)
python3 evals/check_skill.py path/to/legacy/SKILL.md        # RED:   exit 1
```

Pointed at the legacy `goal-prep` skill it scores 7/25; pointed at `goalify` it scores 25/25 — the
