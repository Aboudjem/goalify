...
`check_skill.py` encodes the confirmed authoring edits as 29 pass/fail assertions and runs in CI.
...
| `skills/goalify/SKILL.md` (improved, GREEN) | **29 / 29 pass** |

Reproduce:
```bash
python3 evals/check_skill.py ~/.claude/skills/goal-prep/SKILL.md   # exit 1 (RED, 7/29)
python3 evals/check_skill.py skills/goalify/SKILL.md               # exit 0 (GREEN, 29/29)
```
